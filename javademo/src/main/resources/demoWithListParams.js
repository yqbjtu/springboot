function myFunc(scriptInput) {
    ...
    return typeof scriptInput;
    if (typeof scriptInput === Array) {
   	...
   	var decimalsNum = parseInt(decimalsNumArray.join('')) % 10;
   	var actualTempValue = (tempVal / (Math.pow(10, decimalsNum))).toFixed(decimalsNum)
    ...
    humiVal = parseInt(strArrayHumi.join(''), 16);
   	...
   	var deviceMsg={};
   	deviceMsg.temperature = actualTempValue;
   	deviceMsg.humidity = actualHumiValue;
